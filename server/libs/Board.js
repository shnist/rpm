...
var LEDObj = require('./LED'), 
  ButtonObj = require('./Button'), 
  AnalogInputObj = require('./AnalogInput'), 
  DigitalOutObj = require('./DigitalOutput'), 
  SpeakerObj = require('./Speaker'), 
  MotorObj = require('./Motor');
